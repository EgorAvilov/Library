...
public class ForwardEditBorrowRecordCommandTest {
    @InjectMocks
    ForwardEditBorrowRecordCommand forwardEditBorrowRecordCommand;
    ...
    public void execute_isRoleAdmin() throws CommandException {
        ...
        String result=forwardEditBorrowRecordCommand.execute(request,response);
        String expected= pathCreator.getEditBorrowRecord();
