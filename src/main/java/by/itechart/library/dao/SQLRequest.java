...
public class SQLRequest {
    ...
    public static final String GET_ALL_USERS = "SELECT * FROM users LIMIT ?, ? WHERE deleted_status<>1";
    ...
    public static final String GET_ALL_BOOKS = "SELECT * FROM books LIMIT ?, ? WHERE deleted_status<>1";
    ...
    public static final String COUNT_ROWS_OF_BOOKS = "SELECT count(id) FROM books AND deleted_status<>1";
     ...
     */
    public static final String GET_BORROW_RECORDS_BY_USER_ID = "SELECT * FROM borrow_records WHERE user_id = ? LIMIT ?,? AND deleted_status<>1";
    public static final String GET_ALL_BORROW_RECORDS = "SELECT * FROM borrow_records LIMIT ?, ? WHERE deleted_status<>1";
    ...
    public static final String GET_BORROW_RECORD_BY_ID = "SELECT * FROM borrow_records WHERE id = ? LIMIT ?,? AND deleted_status<>1";
