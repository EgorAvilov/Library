...
public class SQLRequest {
    ...
    public static final String UPDATE_USER = "UPDATE users SET first_name=?, phone_number=?, last_name=?, gender=?, password=? WHERE id=?";
    public static final String CHANGE_USER_DELETED_STATUS = "UPDATE users SET deleted_status=1 WHERE id=?";
    public static final String GET_ALL_USERS = "SELECT * FROM users  WHERE deleted_status<>1";
    ...
    public static final String GET_ALL_BOOKS = "SELECT * FROM books WHERE deleted_status<>1";
    ...
    public static final String CHANGE_BOOK_DELETED_STATUS = "UPDATE books SET deleted_status=1 WHERE id=?";
     ...
     */
    public static final String GET_ALL_BORROW_RECORDS_NEW = "select br.id, b.title, br.return_date, br.due_date, br.borrow_date, u.username, br.status_id, br.comment,b.id from books b JOIN borrow_records br on br.book_id=b.id join users u on br.user_id=u.id";
    public static final String GET_BORROW_RECORDS_BY_USER_ID_NEW ="select br.id, b.title, br.return_date, br.due_date, br.borrow_date, u.username, br.status_id, br.comment, b.id from books b JOIN borrow_records br on br.book_id=b.id join users u on br.user_id=u.id where u.id=?";
    public static final String GET_BORROW_RECORDS_BY_USER_ID = "SELECT * FROM borrow_records WHERE user_id = ?";
    ...
    public static final String GET_BORROW_RECORD_BY_ID = "SELECT * FROM borrow_records WHERE id = ?  AND deleted_status<>1";
